...
De forma complementaria, nalgúns puntos tamén se farán referencias ao ficheiro `AdventureWorks Sales.xlsx`, sobre todo para operacións como renomear consultas, eliminar columnas ou expandir información relacionada.
...
## 3. Abrir Power Query e revisar a situación inicial
...
## 4. Renomear a consulta e entender que problema hai que resolver
...
## 5. Corrixir os valores ausentes representados como `"-"`
...
## 6. Revisar e corrixir os tipos de datos
...
## 7. Despivotar as columnas mensuais
...
- unha columna co nome do mes, por exemplo `Attribute`
- outra columna co valor do obxectivo, por exemplo `Value`
...
## 8. Renomear columnas e deixar a estrutura lista para análise
...
![Renomear columnas despois do unpivot](images/03.limpeza-transformacion-renomear-columnas-unpivot.png)
...
## 9. Revisar se fan falta máis transformacións
...
![Comprobación final da consulta](images/03.limpeza-transformacion-comprobacion-final-consulta.png)
...
## 10. Casos complementarios con Adventure Works
...
### 10.1. Renomear consultas

En modelos con varias táboas, convén usar nomes comprensibles e orientados á análise final.

Por exemplo, unha consulta cun nome técnico pode renomearse para que quede máis clara no panel de campos.

![Renomear consulta en Adventure Works](images/03.limpeza-transformacion-adventureworks-renomear-consulta.png)

### 10.2. Eliminar columnas innecesarias
...
### 10.3. Expandir información relacionada

Nalgúns casos, unha columna contén unha táboa relacionada que se pode expandir para recuperar campos concretos, como categoría, subcategoría ou información xeográfica.

![Expandir columna relacionada](images/03.limpeza-transformacion-adventureworks-expandir-columna.png)

### 10.4. Combinar columnas

Tamén é habitual combinar dous campos para obter unha representación máis útil, por exemplo un nome completo.

![Combinar columnas](images/03.limpeza-transformacion-adventureworks-combinar-columnas.png)

Estes casos non teñen que desenvolverse aquí con tanto detalle como o exemplo principal, pero si convén mencionarlos para que o documento represente mellor o tipo de tarefas reais que se fan en Power Query.

---

## 11. Decidir que consultas cargan ao modelo
...
![Close and Apply](images/03.limpeza-transformacion-close-apply.png)

A partir dese momento, a táboa xa estará lista para pasar ao modelado de datos.

---

## 13. Ideas clave deste bloque
