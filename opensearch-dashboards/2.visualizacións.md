...
En OpenSearch Dashboards non sempre aparece como un tipo de visualización separado. Na práctica, adoita construírse a partir dunha visualización de tipo `Vertical bar` na que o eixo X se configura cun bucket `Histogram`. Aínda así, mantemos este apartado propio porque o obxectivo analítico é diferente do dunha gráfica de barras por categorías.
...
Neste caso, a visualización escóllese como `Vertical bar`, pero compórtase como un histograma porque o eixo X non agrupa categorías con `Terms`, senón intervalos numéricos do campo `latency_ms`.
